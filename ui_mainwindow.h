...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy2.setHeightForWidth(StartHourEdit->sizePolicy().hasHeightForWidth());
        StartHourEdit->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(StartMinuteEdit->sizePolicy().hasHeightForWidth());
        StartMinuteEdit->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(LengthHourEdit->sizePolicy().hasHeightForWidth());
        LengthHourEdit->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(LengthMinuteEdit->sizePolicy().hasHeightForWidth());
        LengthMinuteEdit->setSizePolicy(sizePolicy2);
        ...
        gridLayout->addLayout(EditLayout, 4, 0, 3, 1);
        ...
        sizePolicy3.setHeightForWidth(cwidget->sizePolicy().hasHeightForWidth());
        cwidget->setSizePolicy(sizePolicy3);

        gridLayout->addWidget(cwidget, 0, 1, 4, 1);
